        ...
        <div className="project-details-container">
            ...
            <h3>Gantt Chart</h3>
                <div className="gantt-chart-container">
                    ...
                    {tasks.map(task => {
                        const start = new Date(task.start_date || project.start_date);
                        const due = new Date(task.due_date || start);
                        const offset = (start - new Date(project.start_date)) / (1000 * 60 * 60 * 24);
                                ...
                                <div className="gantt-timeline">
                                    <div
                                        ...
                                        style={{
                                            ...
                                            backgroundColor: colorMap[task.status] || "#95a5a6"
                                        }}
